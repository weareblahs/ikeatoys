runall = async() => {
  ...
  const productID1 = "80522114"; //103.735.89 - BLÅVINGAD
  const productID2 = "10522117"; //005.406.64 - BLÅVINGAD
  const baseURL = "https://api.ingka.ikea.com/cia/availabilities/ru/" + country + "?itemNos=" + productID1 + "," + productID2 + "&expand=StoresList,Restocks,SalesLocations";
  ...
  document.getElementById("detailsPhysical-" + productID1 + "-store2").innerHTML = availabilities[2].availableStocks[0].quantity;
  document.getElementById("detailsPhysical-" + productID1 + "-store3").innerHTML = availabilities[4].availableStocks[0].quantity;
  document.getElementById("detailsPhysical-" + productID1 + "-store4").innerHTML = availabilities[6].availableStocks[0].quantity;
  ...
  document.getElementById("detailsPhysical-" + productID2 + "-store3").innerHTML = availabilities[5].availableStocks[0].quantity;
  document.getElementById("detailsPhysical-" + productID2 + "-store4").innerHTML = availabilities[7].availableStocks[0].quantity;
  ...
  // Counted it for you. 26 conditions.
} 